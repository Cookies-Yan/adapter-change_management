...
const options = {
  url: 'https://dev94800.service-now.com/',
  username: 'admin',
  password: 'N2GJ6OkFdpzf'
};
...
function isHibernating(response) {
  return response.body.includes('Instance Hibernating page') && response.body.includes('<html>') && response.statusCode === 200;
}
